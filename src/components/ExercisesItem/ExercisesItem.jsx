    ...
    <div>
      <Item>
        <Subcategories>
          ...
          <Btn>
            <StartBtn type="button" onClick={() => setModalOpen(true)}>
              Start
            </StartBtn>
            <BasicModalWindow
              isOpen={modalOpen}
        ...
        <Information>
          <p>
            Burned calories: <InformName>{Burned}</InformName>
          </p>
          <p>
            Body part: <InformName>{Body}</InformName>
          </p>
          <p>
            Target: <InformName>{Target}</InformName>
          </p>
        </Information>
      </Item>
    </div>
