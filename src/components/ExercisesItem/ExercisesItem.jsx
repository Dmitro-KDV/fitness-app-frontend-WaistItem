...
import {Item, Workout, StartBtn, NameExercise, Name, Subcategories, Btn, Information, InformName} from './ExercisesItem.stiled';
        ...
        return ( 
            ...
            <Item>
                <Subcategories>
                    ...
                    <Btn>
                        <StartBtn type="button" onClick={()=> setModalOpen(true)}>Start</StartBtn>
                        <BasicModalWindow
                            isOpen={modalOpen}
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
                            <path d="M7.5 14L14 7.5M14 7.5L7.5 1M14 7.5H1" stroke="#E6533C" stroke-width="1.3" stroke-linecap="round" stroke-linejoin="round"/>
                        </svg>
                    </Btn>
                </Subcategories>
                <NameExercise>
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                        ...
                        <path d="M15.8458 7.30102C16.7574 7.30102 17.4963 6.56206 17.4963 5.65051C17.4963 4.73896 16.7574 4 15.8458 4C14.9343 4 14.1953 4.73896 14.1953 5.65051C14.1953 6.56206 14.9343 7.30102 15.8458 7.30102Z" fill="#EFEDE8"/>
                    </svg>
                    <Name>Air bike</Name>
                </NameExercise>
                <Information>
                    <p>Burned calories: <InformName>{Burned}</InformName></p>
                    <p>Body part: <InformName>{Body}</InformName></p>
                    <p>Target: <InformName>{Target}</InformName></p>
                </Information>
            </Item>
            </div>
        );
